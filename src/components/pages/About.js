    ...
    <body className='about-body'>
        <div class="container">
            ...
            <div class="text-box">
                ...
                <p style={{marginBottom: 20}}>At Mount Royal Bagel Factory, we take pride in making our bagels fresh daily, right here in our store. Our team of skilled bakers follows the time-honored Montreal tradition, hand-rolling each bagel to perfection. The result is a bagel that's crispy on the outside, soft and chewy on the inside, and bursting with flavor. Not to mention our wide variety of delicious coffees to go with it. Check out our menu!</p>

                <h2>Visit Us</h2>
                <p style={{marginBottom: 20}}>We invite you to visit our store, where the aroma of freshly baked bagels will greet you at the door. Whether you're a long-time bagel enthusiast or trying Montreal style bagels for the first time, we promise an unforgettable experience.</p>
